...
| :--- | :--- | :--- |
| **Präteritum** | Saturierte | Das materielle Echo der Existenz. |
| **Präsens** | **Saturiert** | Der einzige physikalische Zustand. |
| **Futur I** | Wird saturieren | Eine Konstruktion des Egos zur linearen Planung. |
| **Perfekt** | Hat saturiert | Die Sättigung liegt *vor* der Beobachtung. |
